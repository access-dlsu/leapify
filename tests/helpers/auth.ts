...
/**
 * Build a fake token that LOOKS like a real Google JWT to the middleware.
 *
 ...
 * full `verifyGoogleToken()` path runs — which rejects our fake string.
 *
 ...
 * WITHOUT ever calling verifyGoogleToken.
 */
 ...
 * this object and skip JWT verification entirely.
 */
